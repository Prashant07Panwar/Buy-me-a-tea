...
const Navbar = () => {
  ...
  //   }
  return (
    <nav className="bg-gray-900 shadow-white text-white flex justify-between items-center px-4 h-16">
      <div className="logo font-bold text-lg flex justify-center items-center">
        <img className="rounded-full p-2" src="teaa.gif" width={58} alt="" />
      ...
      <div className="relative">
        {session && 
          <>
            ...
            <div
              id="dropdown"
              className={`z-10 ${showdropdown?"":"hidden"} absolute left-[90px] bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
            >
              <ul
